...
struct Evidence {
    ...
    code_signature_valid_on_disk: bool,
    apple_anchor_requirement_verified: bool,
    arm64_slice_reported: bool,
    proxyjump_untrusted_value_accepted_by_parser: bool,
    native_proxyjump_shell_boundary_source_review: bool,
    upstream_10_4_security_floor_source_review_met: bool,
...
fn collect() -> Result<Evidence, ()> {
    ...
    Ok(Evidence {
        ...
        code_signature_valid_on_disk: signature.status.success(),
        apple_anchor_requirement_verified: false,
        arm64_slice_reported: combined_text(&file)?.contains("arm64"),
        proxyjump_untrusted_value_accepted_by_parser,
        native_proxyjump_shell_boundary_source_review: true,
        upstream_10_4_security_floor_source_review_met: false,
